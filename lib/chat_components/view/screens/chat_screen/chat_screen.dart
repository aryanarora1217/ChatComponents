              ...
              body: SizedBox(
                  ...
                  child: Stack(
                    children: [
                      ...
                      EmptyDataView(
                          title: ChatHelpers.instance.errorMissingData,
                          isButton: false,
                        ...
                        children: [
                              ...
                              Obx(() =>
                                  UserViewChatScreen(
                                    userName: controller.isUserId.isTrue
                                        ...
                                        ? controller.chatRoomModel.value
                                        .userSecond
                                        ?.userName
                                        .toString()
                                        .capitalizeFirst ?? ""
                                    ...
                                    userProfile: controller.isUserId.isTrue
                                        ...
                                        SignType.google.name ? (controller.users
                                        .value
                                        ...
                                        (controller.chatRoomModel.value
                                            .userFirst
                                            ?.userProfile ?? ""),
                                    presence: controller.userTypingStatus
                                        .isFalse
                                    ...
                                    (controller.chatArguments.agoraAppId
                                        ?.isNotEmpty ?? false) &&
                                        controller.agoraChannelName.isNotEmpty
                                        ? Get
                                        ...
                                        arguments: CallArguments(
                                            ...
                                            agoraToken: controller.agoraToken
                                                .value,
                              ...
                              Expanded(
                                ...
                                Column(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        padding: EdgeInsets.only(top: controller
                                            .isLoadingPreviousChats.isFalse
                                            ? ChatHelpers.marginSizeExtraSmall
                                            : 0,
                                            bottom: ChatHelpers
                          ...
                          controller.isLoading.isFalse
                              ...
                              .of(context)
                              .size
                              .width, child: Center(child: LoaderView(
                            loaderColor: controller.themeArguments
                                ?.colorArguments?.mainColor ??
                                ChatHelpers.mainColor,),))
                              : const SizedBox(),
